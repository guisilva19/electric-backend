...
const baseUrl = 'https://guisilva.com.br'
          ...
          <Section style={coverSection}>
            ...
            <Section style={upperSection}>
              ...
              <Section style={verificationSection}>
                <Text style={verifyText}>Informações da solicitação</Text>

                <Text style={codeText}>{nome}</Text>
                <Text style={codeText}>{email}</Text>
                <Text style={codeText}>{telefone}</Text>
